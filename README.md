# JustInTimeDecoding
Data-generation used for simulating the JIT decoder in a cubic lattice, including twisted errors induced by the nonabelian stabilizers of the twisted quantum double model and the heralding heuristic proposed in *insert arXiv identifier here*.  
